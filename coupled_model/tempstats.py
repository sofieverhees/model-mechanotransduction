...
for bigE in Es:
    ...
    axs[0,k].plot(time, Ec[1,:], linestyle='-', color=myred, label='$C_1=0.5$')
    axs[0,k].plot(time, Ec[2,:], linestyle='-', color=mygreen, label='$C_1=1$')
    axs[0,k].plot(time, Ec[3,:], linestyle='-', color=myyellow, label='$C_1=2$')
    ...
    axs[0,k+1].plot(time, Ec[5,:], linestyle='-', color=myred, label='$C_1=0.5$')
    axs[0,k+1].plot(time, Ec[6,:], linestyle='-', color=mygreen, label='$C_1=1$')
    axs[0,k+1].plot(time, Ec[7,:], linestyle='-', color=myyellow, label='$C_1=2$')
    ...
    axs[1,k].plot(time[1:], u_div_l2[1,1:], linestyle='-', color=myred, label='$C_1=0.5$')
    axs[1,k].plot(time[1:], u_div_l2[2,1:], linestyle='-', color=mygreen, label='$C_1=1$')
    axs[1,k].plot(time[1:], u_div_l2[3,1:], linestyle='-', color=myyellow, label='$C_1=2$')
    ...
    axs[1,k+1].plot(time[1:], u_div_l2[5,1:], linestyle='-', color=myred, label='$C_1=0.5$')
    axs[1,k+1].plot(time[1:], u_div_l2[6,1:], linestyle='-', color=mygreen, label='$C_1=1$')
    axs[1,k+1].plot(time[1:], u_div_l2[7,1:], linestyle='-', color=myyellow, label='$C_1=2$')
    ...
    axs[2,k].plot(time, ca[1,:], linestyle='-', color=myred, label='$C_1=0.5$')
    axs[2,k].plot(time, ca[2,:], linestyle='-', color=mygreen, label='$C_1=1$')
    axs[2,k].plot(time, ca[3,:], linestyle='-', color=myyellow, label='$C_1=2$')
    ...
    axs[2,k+1].plot(time, ca[5,:], linestyle='-', color=myred, label='$C_1=0.5$')
    axs[2,k+1].plot(time, ca[6,:], linestyle='-', color=mygreen, label='$C_1=1$')
    axs[2,k+1].plot(time, ca[7,:], linestyle='-', color=myyellow, label='$C_1=2$')

    axs[3,k].set_ylim(0, 0.8*10**(-15))
    ...
    axs[3,k].plot(time, pa[1,:], linestyle='-', color=myred, label='$C_1=0.5$')
    axs[3,k].plot(time, pa[2,:], linestyle='-', color=mygreen, label='$C_1=1$')
    axs[3,k].plot(time, pa[3,:], linestyle='-', color=myyellow, label='$C_1=2$')
    
    axs[3,k+1].set_ylim(0, 0.8*10**(-15))
    ...
    axs[3,k+1].plot(time, pa[5,:], linestyle='-', color=myred, label='$C_1=0.5$')
    axs[3,k+1].plot(time, pa[6,:], linestyle='-', color=mygreen, label='$C_1=1$')
    axs[3,k+1].plot(time, pa[7,:], linestyle='-', color=myyellow, label='$C_1=2$')
